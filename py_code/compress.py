...
args.bs_after_zstd=cctx.compress(bytestream_after_huffman)
...
print("All after Zstd space=",len(args.bs_after_zstd),"bytes")
print("Zstd CR=",len(bytestream_after_huffman)/len(args.bs_after_zstd))
print("Total CR=",args.data_shape[0]*args.data_shape[1]*args.data_shape[2]*4/len(args.bs_after_zstd))
