#ifndef FHDE_COMPRESSOR_TYPE_ONE_HPP
#define FHDE_COMPRESSOR_TYPE_ONE_HPP
...
namespace FHDE{
/**
 * FHDEGenericCompressor glues together decomposition,encoder,and lossless modules to form the compressor.
...
class FHDEGenericCompressor : public concepts::CompressorInterface<T> {
   public:
    FHDEGenericCompressor(Decomposition decomposition,Encoder encoder,Lossless lossless)
...
template <class T,uint N,class Decomposition,class Encoder,class Lossless>
std::shared_ptr<FHDEGenericCompressor<T,N,Decomposition,Encoder,Lossless>> make_compressor_fhde_generic(
    Decomposition decomposition,Encoder encoder,Lossless lossless) {
    return std::make_shared<FHDEGenericCompressor<T,N,Decomposition,Encoder,Lossless>>(decomposition,encoder,lossless);
}
